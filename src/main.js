  ...
  overlay.innerHTML = `
    <div class="login-card" style="text-align:center">
      ...
      <div style="margin-top:16px;font-size:11px;color:#aaa">
        <span style="color:#aaa">小技面板</span>
...
function showLoginOverlay(defaultPw) {
  ...
  overlay.innerHTML = `
    <div class="login-card">
      ${_logoSvg}
      <div class="login-title">小技面板</div>
...
async function boot() {
  ...
  topbar.innerHTML = `
    ...
    <span class="mobile-topbar-title">小技面板</span>
  `
  ...
  try {
    ...
    if (app) app.innerHTML = `
      <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;padding:20px;text-align:center;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif">
        ...
        <div style="margin-top:24px;font-size:11px;color:#a1a1aa">${t('common.pageLoadFailedHint')}<br><a href="https://github.com/sutudio/xiaoji-panel/issues" target="_blank" style="color:#6366f1">项目反馈</a></div>
      </div>`
  }
  startUpdateChecker()
