...
export default {
  ...
  defaultName: _('小技助手', 'Assistant', '', 'AI アシスタント', 'AI 어시스턴트', 'Trợ lý AI', 'Asistente IA', 'Assistente IA', 'ИИ-ассистент', 'Assistant IA', 'KI-Assistent'),
  ...
  stopped: _('已停止', 'Stopped', '', '停止', '중지됨', 'Đã dừng', 'Detenido', 'Parado', 'Остановleno', 'Arrêté', 'Gestoppt'),
  ...
  guideTitle: _('这是小技面板内置的 AI 助手', 'This is the built-in AI assistant', '这是小技面板內置的 AI 助手'),
