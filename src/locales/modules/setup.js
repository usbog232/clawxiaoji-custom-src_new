...
export default {
  ...
  headerTitle: _('欢迎使用小技面板', 'Welcome to Xiaoji Panel', '', 'ClawPanel へようこそ', 'ClawPanel에 오신 것을 환영합니다', 'Chào mừng đến ClawPanel', 'Bienvenido a ClawPanel', 'Bem-vindo ao ClawPanel', 'Добро пожаловать в ClawPanel', 'Bienvenue sur ClawPanel', 'Willkommen bei ClawPanel'),
  ...
  macNodeHint: _('macOS 上从 Finder 启动可能找不到 Node.js。试试关掉小技面板后从终端启动：', 'On macOS, launching from Finder may not find Node.js. Try closing Xiaoji Panel and launching from terminal:', 'macOS 上從 Finder 啟動可能找不到 Node.js。試試關掉 ClawPanel 后從終端啟動：'),
  ...
  aiAssistant: _('小技助手', 'AI Assistant', '', 'AI アシスタント', 'AI 어시스턴트', 'Trợ lý AI', 'Asistente IA', 'Assistente IA', 'ИИ-ассистент', 'Assistant IA', 'KI-Assistent'),
  ...
  installHint: _('点击安装后，将默认安装当前小技面板版本绑定的推荐稳定版；如需升降级，可稍后到「关于」页面切换版本。', 'Installation will use the recommended stable version bound to this Xiaoji Panel release. To change versions later, go to the About page.', '点擊安裝后，將預設安裝目前 ClawPanel 版本綁定的推薦穩定版；如需升降級，可稍后到「關於」頁面切換版本。'),
