...
export default {
  ...
  desc: _('小技面板版本和项目信息', 'XiaoJi Panel version and project info', '小技面板版本和項目資訊'),
  ...
  techStack: _('小技面板基于 Tauri v2 构建，前端 Vanilla JS + Vite，后端 Rust。', 'XiaoJi Panel is built with Tauri v2, Vanilla JS + Vite frontend, Rust backend.'),
  copyright: _('MIT License © 2026 小技面板'),
